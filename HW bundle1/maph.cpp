...
int main() 
{
	...
	while (drawMe >> data ) {
		...
		k++;
		l++;
		if((k + l) % 2) //math algorythm using modulis to create odd and even 
				{
					mapt[k][l].hasT = true;
					mapt[k][l].descriptionT = "You look down and also happen to find some gold";
				}
				else
				{
					mapt[k][l].hasT = false;
					mapt[k][l].descriptionT = "on looking around your area; your able to scavange nothing.";
				}
		if ( l == 6)
               		break;
	}
...
//given code***//given code***//given code***//given code***//given code***//given code***//given code***//given code***//given code***
	...
	while (input != "q") {
		...
		cout << mapt[x][y].descriptionT << endl;
